            ...
            <div className="articlecover" style={{
                ...
                <div className="articlecover-gradient">
                    ...
                    <div className="article-wrapper">
                        <div className="articleinfo">
                            ...
                            <div className="category article-categories" style={{ backgroundColor: "#dc6175" }}>кино</div>
                        </div>
                ...
                <div className="articlecontent-wrapper">
                    ...
                    <div className="other-content">
                        <Postcollection type="кино" title="Гунда" text="Безмолвное рабство" date="16.4.2021" genre="комедия, триллер" poster={bgImageGunda} />
                        <Postcollection type="кино" title="Минари" text="Еда для бедных и богачей" date="9.4.2021" genre="хоррор" poster={bgImageMinari} />
                        <Sidebar />
                    </div>
                </div>
            </div>
